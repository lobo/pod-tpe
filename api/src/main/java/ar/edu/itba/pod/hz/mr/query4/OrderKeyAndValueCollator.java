...
public class OrderKeyAndValueCollator<K extends Comparable<K>,V extends Comparable<V>>
    ...
    public OrderKeyAndValueCollator(boolean firstKey, boolean ascending_key, boolean ascending_value){
